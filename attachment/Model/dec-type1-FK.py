...
if __name__ == '__main__':
    ...
    for r in range(num_R_sum):
        if r < num_R_head:
            ...
            res += operation_7bit_f_k.equal_connect('COPY_OUT2', 0, r, 'xhead', 3, r)
            ...
            res += operation_7bit_f_k.equal_connect('yhead', 2, r, 'xhead', 1, r)
            res += operation_7bit_f_k.equal_connect('yhead', 3, r, 'xhead', 2, r)
            ...
            operation_7bit_f_k.F(r, 0, num_R_head, num_R_color)
            operation_7bit_f_k.AK(r, 0, num_R_head, num_R_color)
            res += operation_7bit_f_k.equal_connect('x', 3, r, 'COPY_IN', 0, r)
            res += operation_7bit_f_k.equal_connect('COPY_OUT1', 0, r, 'F_IN', 0, r)
            res += operation_7bit_f_k.equal_connect('F_OUT', 0, r, 'K_IN', 0, r)
            res += operation_7bit_f_k.equal_connect('K_OUT', 0, r, 'XOR_IN1', 0, r)
            ...
            res += operation_7bit_f_k.equal_connect('x', 1, r, 'y', 2, r)
            res += operation_7bit_f_k.equal_connect('x', 2, r, 'y', 3, r)
            ...
            res += operation_7bit_f_k.equal_connect_linear('COPY_OUT2', 0, r, 'xlinear', 3, r)
            ...
            res += operation_7bit_f_k.equal_connect_linear('ylinear', 2, r, 'xlinear', 1, r)
            res += operation_7bit_f_k.equal_connect_linear('ylinear', 3, r, 'xlinear', 2, r)
    ...
    res = ''
    res += 'ASSERT(x_0_3 = 0bin0000100);\n'
    res += 'ASSERT(x_1_3 = 0bin0000001);\n'
    res += 'ASSERT(x_2_3 = 0bin0000001);\n'
    res += 'ASSERT(x_3_3 = 0bin0000011);\n'
