...
if __name__ == '__main__':
    ...
    for r in range(num_R_sum):
        if r < num_R_head:
            ...
            res += operation_7bit_f_k.equal_connect('yhead', 1, r, 'XOR_IN1', 0, r)
            ...
            operation_7bit_f_k.XOR(r, 0, num_R_head, num_R_color)
            res += operation_7bit_f_k.equal_connect('x', 1, r, 'XOR_IN1', 0, r)
            ...
            operation_7bit_f_k.XOR(r, 0, num_R_head, num_R_color)
            res += operation_7bit_f_k.equal_connect_linear('ylinear', 1, r, 'XOR_IN1', 0, r)
            res += operation_7bit_f_k.equal_connect_linear('COPY_OUT2', 0, r, 'XOR_IN2', 0, r)
